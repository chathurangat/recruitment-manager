...
public class GitHubProvider extends OAuth2Impl{

    private static final Logger LOGGER = LoggerFactory.getLogger(GitHubProvider.class);

    private static final String REQUEST_TOKEN_ENDPOINT = "https://github.com/login/oauth/authorize?response_type=%s&client_id=%s&redirect_uri=%s&state=%s&scope=%s";
    private static final String ACCESS_TOKEN_ENDPOINT = "https://github.com/login/oauth/access_token";
    private static final String PROTECTED_RESOURCE_ENDPOINT = "https://api.github.com/user?access_token=%s";
    ...
    public GitHubProvider(OAuthConfiguration oAuthConfiguration){
...
//                    LOGGER.info(" received the response [{}]", responseString);
                    System.out.println(" received the response ["+responseString+"]");
